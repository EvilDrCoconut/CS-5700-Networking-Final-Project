...
/**
 *  class for a webServer.EchoGetHeader that helps to parse the url request
 */
public class EchoGetHeader implements HandlerInterface{
  ...
  /** constructor for the webServer.EchoGetHeader class
   *
  ...
  // basic functions to return webServer.EchoGetHeader variables
