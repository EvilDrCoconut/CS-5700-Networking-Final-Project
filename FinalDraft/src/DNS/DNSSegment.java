...
public class DNSSegment {
    ...
    static ArrayList<String> readQuestionPayload(byte[] questionPayload) {
        ...
        System.out.println("this is the question type from reading the payload " + qStringAndQtype.get(1));
        return qStringAndQtype;
    }

    static byte[] createResponseSegment(byte[] querySegment, ArrayList<ResourceRecord> rrs) throws IOException {
